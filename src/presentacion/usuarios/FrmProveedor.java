...
public class FrmProveedor extends javax.swing.JPanel {
    ...
    private final byte idTipoRol = 3;
    ...
    public void actualizarRol (int idRol) {
        if (tablaClientes.getSelectedRowCount() == 1) {
            CONTROL.actualizarRol(Integer.parseInt(jtxtIdProveedor.getText()), idRol);
        }
    }
    ...
    private void setEstado (String estado) {
        ...
        labelActivo.setText(estado.equalsIgnoreCase("activo") ? "Proveedor activo" : "Proveedor inactivo");
    }
    ...
    private void initComponents() {
        ...
        jtxtIdProveedor.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        add(jtxtIdProveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 685, 190, 30));
    ...
    private void jbtnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnActualizarActionPerformed
        ...
        if (tablaClientes.getSelectedRowCount() != 1) {
            JOptionPane.showMessageDialog(this, "No ha seleccionado un proveedor de la tabla", "Sistema", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        usuarioActualizar = new UsuarioDTO(Integer.parseInt(jtxtIdProveedor.getText()), jtxtNombres.getText(), jtxtApellidos.getText(), Byte.parseByte(String.valueOf(jcbxGenero.getSelectedIndex())), Utilidades.obtenerFechaChooser(jdcFechaNacimiento), jtxtDocumento.getText(), jtxtDireccion.getText(), jtxtTelefono.getText(), jtxtEmail.getText());

        String respuesta = CONTROL.actualizar(usuarioActualizar);
        if (respuesta.equalsIgnoreCase("OK")) {
            Utilidades.limpiarTextfields(jtxtIdProveedor, jtxtNombres, jtxtApellidos, jtxtDocumento, jtxtDireccion, jtxtTelefono, jtxtEmail, jtxtBuscar);
    ...
    private void tablaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaClientesMouseClicked
        if (tablaClientes.getSelectedRowCount() == 1) {
            try {
                ...
                jtxtIdProveedor.setText(idCliente);
    ...
    private void jbtnActivarDesactivarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnActivarDesactivarActionPerformed
        ...
        if (jtxtIdProveedor.getText().isBlank()) {
            JOptionPane.showMessageDialog(this, "No ha seleccionado un proveedor de la tabla", "Sistema", JOptionPane.WARNING_MESSAGE);
            return;
        }
