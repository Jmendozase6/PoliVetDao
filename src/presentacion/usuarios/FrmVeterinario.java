...
public class FrmVeterinario extends javax.swing.JPanel {

    private final UsuarioControl CONTROL;
    private final byte idTipoRol = 4;
    ...
    private void setEstado (String estado) {
        ...
        labelActivo.setText(estado.equalsIgnoreCase("activo") ? "Veterinario activo" : "Veterinario inactivo");
    }
    ...
    private void tablaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaClientesMouseClicked
        if (tablaClientes.getSelectedRowCount() == 1) {
            try {
                ...
                Logger.getLogger(FrmVeterinario.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
